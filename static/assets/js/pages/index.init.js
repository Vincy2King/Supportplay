...
function themeColor(e) {
    var c = window.localStorage.getItem("color"), d = window.localStorage.getItem("image");
...
!function () {
    var d = !1, u = "users-chat", n = "assets/images/users/user-dummy-img.jpg", m = "users",
        s = window.location.origin + "/assets/js/dir/", f = "", v = 1;
    ...
    var l = document.querySelector("#chatinput-form"), g = document.querySelector("#chat-input"),
        y = document.querySelector(".chat-conversation-list");//, person = document.querySelector("#personal");
    ...
    document.querySelector("#audiofile-input").addEventListener("change", function () {
        ...
        e.readAsDataURL(r), a && a.classList.add("show"), e.addEventListener("load", function () {
            var e = r.name, t = Math.round(r.size / 1e6).toFixed(2);
    ...
    document.querySelector("#attachedfile-input").addEventListener("change", function () {
        ...
        c = document.querySelector("#attachedfile-input").files[0], fr = new FileReader, fr.readAsDataURL(c), a && a.classList.add("show"), fr.addEventListener("load", function () {
            var e = c.name, t = Math.round(c.size / 1e6).toFixed(2);
    ...
    function M(e, t) {
        var a = C, s = document.getElementById(e).querySelector(".chat-conversation-list"), i = "";
        a.forEach(function (e) {
        ...
        }), null != a && (s.insertAdjacentHTML("beforeend", '<li class="chat-list right" id="chat-list-' + w + '" >        <div class="conversation-list">            <div class="user-chat-content">                <div class="ctext-wrap">                    <div class="ctext-wrap-content">                        <div class="message-img mb-0">' + i + '                    </div>                    </div>                    </div>                  <div class="conversation-name">                    <small class="text-muted time">' + '</small>                    <span class="text-success check-message-icon"><i class="bx bx-check"></i></span>                </div>          </div>        </li>'), F(), y.querySelectorAll(".chat-list").forEach(function (e) {
    ...
    l && l.addEventListener("submit", function (e) {
        ...
        null != o || null != o ? M(a) : null != r ? function (e, t, a) {
            ...
            i.querySelectorAll(".delete-item").forEach(function (e) {
                ...
                i.addEventListener("click", function (e) {
                    ...
                    window.File && window.FileReader && window.FileList && window.Blob ? (t = new Blob([L[s]], {type: "application/pdf"}), (a = document.createElement("a")).href = window.URL.createObjectURL(t), a.download = L[s].name, a.click()) : alert("The File APIs are not fully supported in this browser.")
                })
            ...
            i.querySelectorAll(".delete-item").forEach(function (e) {
                ...
                i.addEventListener("click", function (e) {
                    e.preventDefault();
                    var t, a, s = i.getAttribute("data-id");
                    window.File && window.FileReader && window.FileList && window.Blob ? (t = new Blob([L[s]], {type: "application/mp3"}), (a = document.createElement("a")).href = window.URL.createObjectURL(t), a.download = S[s].name, a.click()) : alert("The File APIs are not fully supported in this browser.")
                })
            }), document.querySelector(".file_Upload ").classList.remove("show")
            ...
            w++;
            // console.log('4')
            global_a = document.getElementById(e).querySelector(".chat-conversation-list");
            var a = document.getElementById(e).querySelector(".chat-conversation-list");
            null != t && a.insertAdjacentHTML("beforeend", '<li class="chat-list right" id="chat-list-' + w + '" >                <div class="conversation-list">                    <div class="user-chat-content">                        <div class="ctext-wrap">                            <div class="ctext-wrap-content">                                <p class="mb-0 ctext-content" align="left">' + t + '</p>                            </div>                            <div class="dropdown align-self-start message-box-drop">                                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                                    <i class="ri-more-2-fill"></i>                                </a>                                <div class="dropdown-menu">                                    <a class="dropdown-item d-flex align-items-center justify-content-between reply-message" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between copy-message" href="#" id="copy-message-' + w + '">Copy <i class="bx bx-copy text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Mark as Unread <i class="bx bx-message-error text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" id="delete-item-' + w + '" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a>                            </div>                        </div>                    </div>                    <div class="conversation-name">                        <small class="text-muted time">'  + '</small>                        <span class="text-success check-message-icon"><i class="bx bx-check"></i></span>                    </div>                </div>            </div>        </li>');
            // a.insertAdjacentHTML("beforeend", '<li class="chat-list left" id="chat-list-' + w + '" >                <div class="conversation-list">                    <div class="user-chat-content">                        <div class="ctext-wrap">                            <div class="ctext-wrap-content">                                <p class="mb-0 ctext-content">' + t + '</p>                            </div>                            <div class="dropdown align-self-start message-box-drop">                                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                                    <i class="ri-more-2-fill"></i>                                </a>                                <div class="dropdown-menu">                                    <a class="dropdown-item d-flex align-items-center justify-content-between reply-message" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between copy-message" href="#" id="copy-message-' + w + '">Copy <i class="bx bx-copy text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Mark as Unread <i class="bx bx-message-error text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" id="delete-item-' + w + '" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a>                            </div>                        </div>                    </div>                    <div class="conversation-name">                        <small class="text-muted time">' + h() + '</small>                        <span class="text-success check-message-icon"><i class="bx bx-check"></i></span>                    </div>                </div>            </div>        </li>');
        ...
        for (i = 0; i <w; i++)
            // console.log('here')
            console.log('here:',document.getElementById("chat-list-" + i))
            listItems.push(document.getElementById("chat-list-" + i).querySelector('p.mb-0.ctext-content').textContent)
            // console.log()
        // console.log('before')
        // var listItems = document.getElementById("chat-list-" + w)
        // var number = 10;
        ...
        xhr.send(JSON.stringify(listItems[0]));
        ...
        xhr.onreadystatechange = function(){
            ...
            console.log('results:',response['mp4_file'],response['mp4_img']);
            // mp4_path = response['result']
            // if (mp4_path!='') {
            global_a.insertAdjacentHTML("beforeend", '<li> <div class="col-md-9"> <div class="slider-for-vertical"> <div class="slideshow-gallery-item"> ' +
                '                                        <video controls preload="auto" autoplay="autoplay"  data-setup="{\'autoplay\':true}" style="width:300px;height:300px"> <source src="'+response['mp4_file']+'" type="video/mp4"> </video></div> </div> </div> </li>');
            // global_a.insertAdjacentHTML("beforeend", '<li> <div class="col-md-9"> <div class="slider-for-vertical"> <div class="slideshow-gallery-item"> ' +
            //     '                                        <div class="gallery-block-item style-1" style="background-image: url('+response['mp4_img']+');width:250px; height:250px"><a href=' + response['mp4_file'] + ' class="popup-video"><i class="fa fa-play"></i></a> </div> </div> </div> </div> </li>');
            global_a.insertAdjacentHTML("beforeend",'<li class="chat-list left" id="chat-list-' + w + '" >                <div class="conversation-list">                    <div class="user-chat-content">                        <div class="ctext-wrap">                            <div class="ctext-wrap-content">                                <p class="mb-0 ctext-content" align="left">' + response['response'] + '</p>                            </div>                            <div class="dropdown align-self-start message-box-drop">                                <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                                    <i class="ri-more-2-fill"></i>                                </a>                                <div class="dropdown-menu">                                    <a class="dropdown-item d-flex align-items-center justify-content-between reply-message" href="#" data-bs-toggle="collapse" data-bs-target=".replyCollapse">Reply <i class="bx bx-share ms-2 text-muted"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#" data-bs-toggle="modal" data-bs-target=".forwardModal">Forward <i class="bx bx-share-alt ms-2 text-muted"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between copy-message" href="#" id="copy-message-' + w + '">Copy <i class="bx bx-copy text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Bookmark <i class="bx bx-bookmarks text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Mark as Unread <i class="bx bx-message-error text-muted ms-2"></i></a>                                    <a class="dropdown-item d-flex align-items-center justify-content-between delete-item" id="delete-item-' + w + '" href="#">Delete <i class="bx bx-trash text-muted ms-2"></i></a>                            </div>                        </div>                    </div>                    <div class="">                        <small class="text-muted time">' + '</small>                        <span class="text-success check-message-icon"><i class="bx bx-check"></i></span>                    </div>                </div>            </div>        </li>')
        }
            // }
        }
        ...
        //         data: JSON.stringify({ items: listItems }),  // 将<li>内容作为JSON发送
        //         success: function(response) {
        //             alert('后端接收到的数据: ' + response.received_data);
        //         },
     ...
     // console.log('here')
     // document.querySelector("#person_btn").addEventListener("click", function(e) {
     //     // e.preventDefault();
     ...
     //            // if (mp4_path!='') {
     //            global_a.insertAdjacentHTML("beforeend", '<li> <div class="col-md-9"> <div class="slider-for-vertical"> <div class="slideshow-gallery-item"> ' +
     //                '                                        <div class="gallery-block-item style-1"><a href=' + response['result'] + ' class="popup-video"><i class="fa fa-play"></i></a> </div> </div> </div> </div> </li>')
     //        }
     //        // Use fetch to send POST request to the Flask app
     //        fetch('/personal', {
     //            method: 'POST',
     //            headers: {
    ...
    function H(e, t, a, s, i) {
        ...
        if (null != t) l += '<div class="ctext-wrap-content" id=' + e + '>        <p class="mb-0 ctext-content" align="left">' + t + "</p></div>"; else if (a && 0 < a.length) {
        ...
        t = e, a = function (e, t) {
            ...
            null !== e ? console.log("Something went wrong: " + e) : (l = "users" == m ? t[0].chats : t[0].channel_chat, document.getElementById(m + "-conversation").innerHTML = "", n = 0, l.forEach(function (t, e) {
                ...
                0 < n ? --n : (a = t.from_id == v ? " right" : " left", s = f.find(function (e) {
                    ...
                    return s
                }(l, e, t.from_id)), i += '<div class="conversation-name"><small class="text-muted time">' +  '</small> <span class="text-success check-message-icon"><i class="bx bx-check-double"></i></span></div>', i += "</div>                </div>            </li>", document.getElementById(m + "-conversation").innerHTML += i)
